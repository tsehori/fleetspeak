...
func (x *Message) GetCreationTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *Message) GetData() *any.Any {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *MessageResult) GetProcessedTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *ContactData) GetClientClock() *timestamp.Timestamp {
	if x != nil {
