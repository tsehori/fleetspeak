...
func (x *ClientResourceUsageRecord) GetProcessStartTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *ClientResourceUsageRecord) GetClientTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *ClientResourceUsageRecord) GetServerTimestamp() *timestamp.Timestamp {
	if x != nil {
...
var file_fleetspeak_src_server_proto_fleetspeak_server_resource_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xf2, 0x04, 0x0a, 0x19, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73,
	...
	0x6d, 0x6f, 0x72, 0x79, 0x4d, 0x69, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
